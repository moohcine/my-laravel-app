...
@section('title', __('Admin Login – NDC PRO'))
        ...
        <div class="row align-items-center justify-content-center" style="min-height: 80vh;">
            <div class="col-lg-6 text-center text-lg-start mb-4 mb-lg-0">
                ...
                <h1 class="display-5 fw-bold text-white mb-3">
                    {{ __('Admin control') }} <span class="text-info">{{ __('pour NDC PRO') }}</span>
                </h1>
                <p class="lead text-secondary mb-4">
                    {{ __('Connectez-vous pour superviser les demandes, les groupes et la présence des stagiaires dans NDC PRO.') }}
                </p>
            </div>
            <div class="col-md-8 col-lg-5 fade-up">
                <div class="ndc-card p-4 p-md-5">
                    ...
                    <p class="text-secondary mb-4">
                        {{ __('Accédez au tableau de bord sécurisé.') }}
                    </p>
